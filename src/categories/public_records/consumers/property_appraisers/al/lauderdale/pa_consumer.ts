...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://www.deltacomputersystems.com/al/al41/pappraisala.html'
    }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        while (true){
            ...
            try{
                await page.goto('http://www.deltacomputersystems.com/al/al41/pappraisala.html'); // Go to search page
            } catch(error){
                await page.reload();
            }
            try{
                ...
                for (const datalink of datalinks) {
                    ...
                    dataFromPropertyAppraisers['Property State'] = this.publicRecordProducer.state;
                    try{

    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        let document = docsToParse;
            ...
            while (true){
                ...
                try{
                    await page.goto('http://www.deltacomputersystems.com/al/al47/pappraisala.html'); // Go to search page
                } catch(error){
                    await page.reload();
                }
                try{
                    ...
                    for (const datalink of datalinks) {
                        ...
                        dataFromPropertyAppraisers['County'] = 'madison';
                        dataFromPropertyAppraisers['Property State'] = "AL";
                        try{

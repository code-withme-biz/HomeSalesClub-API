...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://ptc.shelbyal.com/CA_PropertyTaxSearch.aspx'
    }
              ...
              try {
                ...
                for (const row of rows) {
                  ...
                  if (flag) {
                    ...
                    await detailPage.goto(`https://ptc.shelbyal.com/CA_PropertyTaxParcelInfo.aspx?ParcelNo=${parcel_no}&TaxYear=2020`, {waitUntil: 'load'});
    ...
    async getPropertyInfos(page: puppeteer.Page, property_type: string): Promise<any> {
      ...
      // sales
      const [salesbutton] = await page1.$x('//*[@id="Sales"]')
      await page1.evaluate(el => el.click(), salesbutton);
      await page2.waitForXPath('//*[text()="Sale Date"]', {visible: true});
      ...
      const [buildingbutton] = await page1.$x('//*[@id="Buildings"]')
      await page1.evaluate(el => el.click(), buildingbutton);
      await page2.waitForXPath(year_built_xpath, {visible: true});

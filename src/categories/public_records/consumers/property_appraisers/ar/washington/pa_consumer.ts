...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://www.actdatascout.com/RealProperty/Arkansas/Washington'
    }
    ...
    async getPropertyInfos(page: puppeteer.Page): Promise<any> {
      ...
      // sales info"
      const last_sale_recording_date_xpath = '//tr[@id="DocumentLinks"]/td[2]';
      const last_sale_amount_xpath = '//tr[@id="DocumentLinks"]/td[7]';

...
//                 const searchAddress = await californiaHelper.searchAddress(page, 'SCL', document["Property Address"]);
...
//                 try {
//                     const result = await californiaHelper.parseJsonData(data, document["Property Address"], 'Santa Clara');

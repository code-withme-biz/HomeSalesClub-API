...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://qpublic.schneidercorp.com/Application.aspx?AppID=605&LayerID=9946&PageTypeID=2&PageID=4381'
    }

    xpaths = {
        isPAloaded: '//input[contains(@id, "_txtAddress")]'
    }
    ...
    async getPropertyInfos(page: puppeteer.Page): Promise<any> {
      // name and addr
      const owner_names = [];
      const name_xpath = '//*[contains(@id, "_lblDeedName")]';
      ...
      let mailing_address = await this.getInnerTextByXpathFromPage(page, mailing_address_xpath);
      mailing_address = this.simplifyString(mailing_address);
      const mailing_city_xpath  = '//*[contains(@id, "_lblCityStateZip")]';
      let mailing_city_state: any = await this.getInnerTextByXpathFromPage(page, mailing_city_xpath);
      let mailing_zip = '';
      let mailing_state = '';
      let mailing_city = '';
      const mailing_address_parsed = parser.parseLocation(mailing_address + ' ' + mailing_city_state);
      ...
      // property address
      const property_address_xpath = '//*[text()="Location Address"]/ancestor::tr[1]/td';
      ...
      // property type
      const property_type_xpath = '//*[text()="Property Class"]/ancestor::tr[1]/td';
      ...
      // sales info
      const last_sale_recording_date_xpath = '//th[text()="Sale Date"]/parent::tr/parent::thead/following-sibling::tbody/tr[1]/th[1]';
      const last_sale_amount_xpath = '//th[text()="Sale Date"]/parent::tr/parent::thead/following-sibling::tbody/tr[1]/td[1]';
      ...
      const total_assessed_value_xpath = '//th[text()="Total Assessed Value"]/following-sibling::td[1]';
      const est_value_xpath = '//th[text()="Just Market Value"]/following-sibling::td[1]';

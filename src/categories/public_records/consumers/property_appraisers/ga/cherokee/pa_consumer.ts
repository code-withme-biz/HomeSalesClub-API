...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    last_sale_date_xpath = '//div[@id="panel_section_sales"]//table/tbody[1]/tr/td[3]';
    last_sale_amount_xpath = '//div[@id="panel_section_sales"]//table/tbody[1]/tr/td[6]';
    property_type_xpath = '//p[./span[contains(., "Land Use Code")]]/span[2]';
    ...
    urls = {
        propertyAppraiserPage: 'https://property.spatialest.com/ga/cherokee/#/'
    }
    ...
    async parseResult(page: puppeteer.Page, link: any, document: IOwnerProductProperty, address: any) {
        ...
        if(total_assessed_value == 'PENDING'){
            try {
                total_assessed_value = await page.evaluate(el => el.textContent, (await page.$x('//span[text()="Prior Value"]/parent::p/span[2]'))[0]);
            } catch {
                total_assessed_value = '';
            }
        }
        est_value = total_assessed_value;
        try {
        ...
        let mailing_city = mailing_address_2_arr.pop().trim();
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        const url_search = 'https://property.spatialest.com/ga/cherokee/#/';

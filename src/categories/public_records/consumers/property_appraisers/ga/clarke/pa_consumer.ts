...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://qpublic.schneidercorp.com/Application.aspx?App=ClarkeCountyGA&Layer=Parcels&PageType=Search'
    }
    ...
    async getPropertyInfos(page: puppeteer.Page): Promise<any> {
        // name and addr
        const owner_names = [];
        const name_xpath = '//*[contains(@id, "ctlBodyPane_ctl01_ctl01_lnkOwnerName_lblSearch") or contains(@id, "ctlBodyPane_ctl01_ctl01_lnkOwnerName_lnkSearch")]';
        ...
        // mailing address
        const mailing_address_xpath  = '//*[contains(@id, "ctlBodyPane_ctl01_ctl01_lblAddress")]';
        ...
        const mailing_city_xpath  = '//*[contains(@id, "ctlBodyPane_ctl01_ctl01_lblCityStateZip")]';
        ...
        // property type
        const property_type_xpath = '//*[text()="Class"]/ancestor::tr[1]/td';
        ...
        const last_sale_amount_xpath = '//th[text()="Sale Date"]/parent::tr/parent::thead/following-sibling::tbody/tr[1]/td[3]';
        ...
        const est_value_xpath = '//th[text()="Current Value"]/following-sibling::td';

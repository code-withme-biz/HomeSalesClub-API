...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://linn.iowaassessors.com/search.php'
    }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        let document = docsToParse;
            ...
            if (this.searchBy === 'name') {
                console.log("By name detected! The site is only supported searched by property address: https://linn.iowaassessors.com/search.php");
                return false;
            }
            ...
            while (true){
              ...
              try {
                ...
                let found = await page.$x('//div[@id="pclGeneralInfo"]');
                if(found.length < 1){
    ...
    async getPropertyInfos(page: puppeteer.Page, parsed_addr: any): Promise<any> {
        ...
        // mailing address
        const mailing_address_xpath = '//td[contains(., "Mailing Address:")]/parent::tr/td[2]/text()[1]';

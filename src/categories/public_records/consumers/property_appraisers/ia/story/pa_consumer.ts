...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://beacon.schneidercorp.com/Application.aspx?AppID=165&LayerID=2145&PageTypeID=2&PageID=1104'
    }
    ...
    async getPropertyInfos(page: puppeteer.Page): Promise<any> {
      // name and addr
      const owner_names = [];
      const name_xpath = '//*[contains(@id, "lblDeedName")]';
      ...
      // mailing address
      const mailing_address_xpath  = '//*[contains(@id, "ctlBodyPane_ctl01_ctl01_lstMailing_ctl01_lblMailing")]';
      ...
      // property address
      const property_address_xpath = '//*[contains(@id, "ctlBodyPane_ctl00_ctl01_lblPropertyAddress")]';
      ...
      // property type
      const property_type_xpath = '//*[text()="Primary Class"]/ancestor::tr[1]/td';
      ...
      // sales info
      const last_sale_recording_date_xpath = '//th[text()="Buyer"]/parent::tr/parent::thead/following-sibling::tbody/tr[1]/th[1]';
      const last_sale_amount_xpath = '//th[text()="Buyer"]/parent::tr/parent::thead/following-sibling::tbody/tr[1]/td[last()]';
      ...
      const total_assessed_value_xpath = '//th[text()="Net Assessed Value"]/following-sibling::td[1]';

...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://adamsil.devnetwedge.com/'
    }
                ...
                if (multi_results) {
                  ...
                  if(this.searchBy == 'address'){
                    ...
                    if (property_handle) {
                        ...
                        await page.goto('https://adamsil.devnetwedge.com/parcel/view/' + property_number.replace(/-/g, '') + '/' + currentYear, {waitUntil: 'networkidle0'});
                    ...
                    for(const row of search_results){
                        ...
                        link = "https://adamsil.devnetwedge.com/parcel/view/" + link?.replace(/-/g, '') + '/' + currentYear;

                ...
                if (multi_results) {
                  ...
                  if(this.searchBy == 'address'){
                    ...
                    if (property_handle) {
                        ...
                        await page.goto('https://stclairil.devnetwedge.com/parcel/view/' + property_number.replace(/-|\./g, '') + '/' + currentYear, {waitUntil: 'networkidle0'});
                    ...
                    for(const row of search_results){
                        ...
                        link = "https://stclairil.devnetwedge.com/parcel/view/" + link?.replace(/-|\./g, '') + '/' + currentYear;

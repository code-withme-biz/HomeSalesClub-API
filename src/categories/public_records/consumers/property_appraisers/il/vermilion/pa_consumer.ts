...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://vermilionil.devnetwedge.com/'
    }
                ...
                if (multi_results) {
                  ...
                  if(this.searchBy == 'address'){
                    ...
                    if (property_handle) {
                        ...
                        await page.goto('https://vermilionil.devnetwedge.com/parcel/view/' + property_number.replace(/-/g, '') + '/' + currentYear, {waitUntil: 'networkidle0'});
                    ...
                    for(const row of search_results){
                        ...
                        link = "https://vermilionil.devnetwedge.com/parcel/view/" + link?.replace(/-/g, '') + '/' + currentYear;

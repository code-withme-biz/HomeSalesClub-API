...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    last_sale_date_xpath = '//div[@id="panel_section_TransferHistory"]//table/tbody[1]/tr/td[1]';
    last_sale_amount_xpath = '//div[@id="panel_section_TransferHistory"]//table/tbody[1]/tr/td[2]';
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        const url_search = 'https://prc-buncombe.spatialest.com/#/';

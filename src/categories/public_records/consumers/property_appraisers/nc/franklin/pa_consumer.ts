...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPageOwner: 'https://www.franklincountytax.us/search/commonsearch.aspx?mode=OWNER',
        propertyAppraiserPageAddress: 'https://www.franklincountytax.us/search/commonsearch.aspx?mode=ADDRESS'
    }
    ...
    async getPropertyInfos(page: puppeteer.Page): Promise<any> {
      ...
      const last_sale_amount_xpath = '//td[contains(., "Sale Price")]/following-sibling::td[1]';

...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    last_sale_date_xpath = '//p[./span[contains(., "Last Sale Date")]]/span[2]';
    last_sale_amount_xpath = '//p[./span[contains(., "Last Sale Price")]]/span[2]';
    property_type_xpath = '//p[./span[contains(., "Land Use Desc")]]/span[2]';
    ...
    urls = {
        propertyAppraiserPage: 'https://mnc.spatialest.com/#/'
    }
    ...
    async parseResult(page: puppeteer.Page, link: any, document: IOwnerProductProperty, address: any) {
        ...
        let property_address, property_type, last_sale_date, total_assessed_value, last_sale_amount, year_built;
        ...
        let mailing_city = '';
        for (let c of mailing_address_2_arr) {
            mailing_city += c + " ";
        }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        const url_search = 'https://mnc.spatialest.com/#/';

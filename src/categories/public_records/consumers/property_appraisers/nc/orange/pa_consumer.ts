...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    last_sale_date_xpath = '//div[@id="SalesTab"]//table/tbody[1]/tr/td[1]';
    last_sale_amount_xpath = '//div[@id="SalesTab"]//table/tbody[1]/tr/td[2]';
    property_type_xpath = '//p[./span[contains(., "Property LUC")]]/span[2]';
    ...
    urls = {
        propertyAppraiserPage: 'https://property.spatialest.com/nc/orange/#/'
    }
    ...
    async parseResult(page: puppeteer.Page, link: any, document: IOwnerProductProperty, address: any) {
        ...
        let property_address, property_type, last_sale_date, total_assessed_value, last_sale_amount, year_built, property_city;
        ...
        try {
            property_city = await page.evaluate(el => el.textContent, (await page.$x('//p[./span[contains(., "Township")]]/span[2]'))[0]);
            property_city = property_city.split(' - ')[1].trim();
        } catch {
            property_city = '';
        }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        const url_search = 'https://property.spatialest.com/nc/orange/#/';

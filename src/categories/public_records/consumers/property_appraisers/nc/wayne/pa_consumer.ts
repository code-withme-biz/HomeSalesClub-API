...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://realestate.waynegov.com/ITSNet/'
    }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean>   {
        ...
        let document = docsToParse;
            ...
            if (this.searchBy === 'name') {
              ...
              url = `http://realestate.waynegov.com/ITSNet/SearchResults.aspx?field=owner&name=${search_value}`;
              ...
              url = `http://realestate.waynegov.com/ITSNet/SearchResults.aspx?field=address&house=${parseaddr1.number}&road=${parseaddr1.street}&type=&match=2&order=Address`;
                ...
                while (true) {
                  ...
                  for(const row of rows) {
                    ...
                    if (flag) {
                      ...
                      await detailPage.goto(`http://realestate.waynegov.com/ITSNet/${link}`, {waitUntil: 'load'});

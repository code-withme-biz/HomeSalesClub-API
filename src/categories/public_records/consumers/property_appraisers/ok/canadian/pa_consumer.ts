...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    last_sale_date_xpath = '//div[@id="SalesTab"]//table/tbody[1]/tr[1]/td[1]';
    last_sale_amount_xpath = '//div[@id="SalesTab"]//table/tbody[1]/tr[1]/td[2]';
    ...
    urls = {
        propertyAppraiserPage: 'https://property.spatialest.com/ok/canadian/#/'
    }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        const url_search = 'https://property.spatialest.com/ok/canadian/#/';

...
//     urls = {
//         propertyAppraiserPage: 'http://asp.rutherfordcountytn.gov/apps/propertydata/RealPropertySearch2.aspx'
//     }

//     xpaths = {
//         isPAloaded: '//input[@id="MainContent_TextBox1"]'
//     }
...
//               try {                
//                 // input address
//                 const inputNumberHandle = await page.$x('//input[@id="MainContent_TextBox1"]');
//                 const inputAddrHandle = await page.$x('//input[@id="MainContent_TextBox2"]');
...
//                 await Promise.all([
//                   inputAddrHandle[0].type(String.fromCharCode(13), {delay: 150}),
//                   page.waitForSelector('table#MainContent_GridView1')
//                 ]);
                
//                 // check result
//                 const link_handle = await page.$('table#MainContent_GridView1 > tbody > tr > td:nth-child(6) > a');
//                 if (link_handle) {
//                   await Promise.all([
//                     link_handle.click(),
...
//       // name
//       let owner_names = [];
//       const owner_name1_selector = 'div#TabContainer1_TabPanel1 > table > tbody > tr:nth-child(2) > td:nth-child(2) > span';
//       const owner_name2_selector = 'div#TabContainer1_TabPanel1 > table > tbody > tr:nth-child(3) > td:nth-child(2) > span';
//       let owner_name1 = await this.getElementTextContent(page, owner_name1_selector);
//       let owner_name2 = await this.getElementTextContent(page, owner_name2_selector);
//       const ownerName1 = this.parseOwnerName(owner_name1);
//       const ownerName2 = this.parseOwnerName(owner_name2);
//       owner_names.push(ownerName1);
//       if (owner_name2 != '')
//         owner_names.push(ownerName2);

//       // mailing address
//       const address_selector = 'div#TabContainer1_TabPanel1 > table > tbody > tr:nth-child(4) > td:nth-child(2) > span';
//       const city_selector = 'div#TabContainer1_TabPanel1 > table > tbody > tr:nth-child(6) > td:nth-child(2) > span';
//       let owner_address = await this.getElementTextContent(page, address_selector);
//       let city_state = await this.getElementTextContent(page, city_selector);
//       const mailing_address = owner_address.trim() + ', ' + city_state.trim();
...
//       // property type
//       const property_type_selector ='div#TabContainer1_TabPanel1 > table > tbody > tr:nth-child(16) > td:nth-child(2) > span';
//       let property_type = await this.getElementTextContent(page, property_type_selector);
//       if (property_type.indexOf('-') > -1)
//         property_type = property_type.slice(property_type.indexOf('-')+1);
//       property_type = property_type.trim();

//       // sales info
//       const last_sale_recording_date_selector = 'table#TabContainer1_TabPanel1_GridView4 > tbody > tr:nth-child(2) > td:first-child';
//       const last_sale_amount_selector = 'table#TabContainer1_TabPanel1_GridView4 > tbody > tr:nth-child(2) > td:nth-child(2)';
...
//       const total_assessed_value_selector = 'div#TabContainer1_TabPanel1 > table > tbody > tr:nth-child(22) > td:nth-child(2) > span';
//       const est_value_selector = 'div#TabContainer1_TabPanel1 > table > tbody > tr:nth-child(20) > td:nth-child(2) > span';
//       let total_assessed_value = await this.getElementTextContent(page, total_assessed_value_selector);
//       if (!total_assessed_value) total_assessed_value = '';
//       let est_value = await this.getElementTextContent(page, est_value_selector);
//       if (!est_value) est_value = '';

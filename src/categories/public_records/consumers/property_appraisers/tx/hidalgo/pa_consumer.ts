...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://propaccess.hidalgoad.org/ClientDB/PropertySearch.aspx?cid=1'
    }
                ...
                while (true) {
                  ...
                  for(const row of rows) {
                    ...
                    if (flag) {
                      ...
                      await detailPage.goto(`http://propaccess.hidalgoad.org/ClientDB/${link}`, {waitUntil: 'load'});

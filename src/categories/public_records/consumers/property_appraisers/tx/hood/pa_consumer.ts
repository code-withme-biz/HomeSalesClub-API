...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://iswdataclient.azurewebsites.net/webSearchAddress.aspx?dbkey=hoodcad',
        searchByNamePage: 'http://iswdataclient.azurewebsites.net/webSearchName.aspx?dbkey=hoodcad'
    }
    ...
    async parsePage(page: puppeteer.Page, propertyAddress: any, id: string) {
        ...
        await page.goto(`http://iswdataclient.azurewebsites.net/webProperty.aspx?dbkey=hoodcad&id=${id}`);
        ...
        let document = docsToParse;
            ...
            try {
                ...
                if (this.searchBy === 'address') {
                    await page.goto('http://iswdataclient.azurewebsites.net/webSearchAddress.aspx?dbkey=hoodcad');
                    ...
                    await page.goto('http://iswdataclient.azurewebsites.net/webSearchName.aspx?dbkey=hoodcad');

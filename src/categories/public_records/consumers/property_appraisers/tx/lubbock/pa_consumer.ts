...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://lubbockcad.org/'
    }
                ...
                while (true) {
                  ...
                  for(const row of rows) {
                    ...
                    if (flag) {
                      ...
                      await detailPage.goto(`https://lubbockcad.org/Property-Detail/PropertyQuickRefID/${id1}/PartyQuickRefID/${id2}`, {waitUntil: 'load'});

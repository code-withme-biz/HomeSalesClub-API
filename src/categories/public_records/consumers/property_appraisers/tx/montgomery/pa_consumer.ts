...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://mcad-tx.org/'
    }
                ...
                while (true) {
                  ...
                  for(const row of rows) {
                    ...
                    if (flag) {
                      ...
                      await detailPage.goto(`https://mcad-tx.org/Property-Detail/PropertyQuickRefID/${id1}/PartyQuickRefID/${id2}`, {waitUntil: 'load'});

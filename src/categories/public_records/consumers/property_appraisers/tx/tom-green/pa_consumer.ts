...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://iswdataclient.azurewebsites.net/webSearchAddress.aspx?dbkey=tomgreencad',
        searchByNamePage: 'http://iswdataclient.azurewebsites.net/webSearchName.aspx?dbkey=tomgreencad'
    }
    ...
    async parsePage(page: puppeteer.Page, propertyAddress: any, id: string) {
        ...
        await page.goto(`http://iswdataclient.azurewebsites.net/webProperty.aspx?dbkey=tomgreencad&id=${id}`);
        ...
        let document = docsToParse;
            ...
            try {
                ...
                if (this.searchBy === 'address') {
                    await page.goto('http://iswdataclient.azurewebsites.net/webSearchAddress.aspx?dbkey=tomgreencad');
                    ...
                    await page.goto('http://iswdataclient.azurewebsites.net/webSearchName.aspx?dbkey=tomgreencad');

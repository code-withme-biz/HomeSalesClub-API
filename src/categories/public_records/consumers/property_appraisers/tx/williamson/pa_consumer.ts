...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://search.wcad.org/'
    }
        ...
        let document = docsToParse;
            ...
            if (this.searchBy === 'name') {
              ...
              search_value = owner_name;
                ...
                parsed_addr = parser.parseLocation(search_value);
            ...
            while (true){
              ...
              try {
                ...
                await inputAddrHandle.type(String.fromCharCode(13), {delay: 150});
                ...
                while (true) {
                  ...
                  for(const row of rows) {
                    ...
                    if (flag) {
                      ...
                      await detailPage.goto(`https://search.wcad.org/Property-Detail/PropertyQuickRefID/${id1}/PartyQuickRefID/${id2}`, {waitUntil: 'load'});

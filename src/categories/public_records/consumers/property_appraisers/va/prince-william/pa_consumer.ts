...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://pwc.publicaccessnow.com/AddressSearch.aspx'
    }

    xpaths = {
        isPAloaded: '//input[@id="HouseNoLow"]'
    }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        let document = docsToParse;
            ...
            if (this.searchBy === 'name') {
                console.log("By name detected! The site is only supported searched by property address: http://pwc.publicaccessnow.com/AddressSearch.aspx");
                return false;
            ...
            while (true){
              ...
              try {
                await page.waitForSelector('input#HouseNoLow');
                if(parsed_addr.number){
                    await page.type('input#HouseNoLow', parsed_addr.number, {delay: 50})
                }
                if(parsed_addr.street){
                    await page.type('input#Street', parsed_addr.street, {delay: 50})
                }
                await Promise.all([
                    page.click('button[name="btnSearch"]'),
                    page.waitForNavigation({waitUntil: 'networkidle0'})
                ]);
                let found = await page.$x('//td[text()="Owner Name"]/parent::tr/td[2]');
                if(found.length < 1){
    ...
    async getPropertyInfos(page: puppeteer.Page): Promise<any> {
        // name
        const full_name_xpath = '//td[text()="Owner Name"]/parent::tr/td[2]';
        ...
        // property address
        const property_address_xpath = '//td[text()="Property Address:"]/parent::tr/parent::tbody/tr[2]/td[1]/text()[1]';
        ...
        const property_address_2_xpath = '//td[text()="Property Address:"]/parent::tr/parent::tbody/tr[2]/td[1]/text()[last()]';
        ...
        // mailing address
        const mailing_address_xpath = '//td[text()="Owner Address"]/parent::tr/td[2]';
        const mailing_address_2_xpath = '//td[text()="Owner Address"]/ancestor::tbody/tr[4]/td[2]';
        ...
        // sales info"
        const last_sale_recording_date_xpath = '//th[text()="Sale Amount"]/parent::tr/parent::thead/parent::table/tbody/tr[1]/td[1]';
        const last_sale_amount_xpath = '//th[text()="Sale Amount"]/parent::tr/parent::thead/parent::table/tbody/tr[1]/td[2]';
        ...
        const est_value_xpath = '//td[text()="Total - Market Value"]/parent::tr/td[4]'

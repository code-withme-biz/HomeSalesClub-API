...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'https://propertysearch.co.benton.wa.us/propertyaccess/PropertySearch.aspx?cid=0'
    }
        ...
        let document = docsToParse;
            ...
            while (true){
              ...
              try {
                // input address
                if(this.searchBy == 'name'){
                    await page.select('#propertySearchOptions_searchType', 'owner');
                    await page.type('#propertySearchOptions_ownerName', owner_name, {delay: 150});
                } else {
                ...
                while (true) {
                  ...
                  for(const row of rows) {
                    ...
                    let name = await row.evaluate(el => el.children[7].textContent?.trim()) || '';
                    let flag = false;
                    ...
                    if (flag) {
                      ...
                      await detailPage.goto(`https://propertysearch.co.benton.wa.us/propertyaccess/${link}`, {waitUntil: 'load'});

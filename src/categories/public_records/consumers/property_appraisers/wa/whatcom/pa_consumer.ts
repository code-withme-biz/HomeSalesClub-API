...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://property.whatcomcounty.us/propertyaccess/PropertySearch.aspx?cid=0'
    }
                ...
                while (true) {
                  ...
                  for(const row of rows) {
                    ...
                    if (flag) {
                      ...
                      await detailPage.goto(`http://property.whatcomcounty.us/propertyaccess/${link}`, {waitUntil: 'load'});

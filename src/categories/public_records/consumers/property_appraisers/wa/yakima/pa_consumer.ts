...
export default class PAConsumer extends AbstractPAConsumer {
    ...
    urls = {
        propertyAppraiserPage: 'http://yes.co.yakima.wa.us/AssessorAPI/Property_Search.html'
    }

    xpaths = {
        isPAloaded: '//input[@id="txtStrSearch"]'
    }
    ...
    async parseAndSave(docsToParse: IOwnerProductProperty): Promise<boolean> {
        ...
        let document = docsToParse;
            ...
            if (this.searchBy === 'name') {
                console.log("By name detected! The site is only supported searched by property address: http://yes.co.yakima.wa.us/AssessorAPI/Property_Search.html");
                return false;
            }
            ...
            while (true){
              ...
              try {
                await page.waitForSelector('input#txtStrSearch');
                await page.click('input#situsRadio');
                await page.type('#txtStrSearch', search_addr);
                await page.click('button[type="submit"]');
                try{
                    await page.waitForXPath('//span[text()="Owners:"]', {timeout: 20000})
                } catch(e){
    ...
    async getPropertyInfos(page: puppeteer.Page): Promise<any> {
        // name
        const full_name_xpath = '//span[text()="Owners:"]/parent::div/span[2]';
        ...
        // property type
        const property_type_xpath = '//span[text()="Property Type:"]/parent::div/span[2]';
        const property_type = await this.getTextByXpathFromPage(page, property_type_xpath);
        const year_built = await this.getTextByXpathFromPage(page, '//span[text()="Year Built:"]/parent::div/span[2]');

        // sales info"
        const last_sale_recording_date_xpath = '//table[contains(., "Excise Transactions")]/tbody/tr[1]/td[3]';
        const last_sale_amount_xpath = '//table[contains(., "Excise Transactions")]/tbody/tr[1]/td[4]';
        ...
        const total_assessed_value_xpath = '//td[contains(., "Taxable Value Regular")]/parent::tr/td[2]';

...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://recorder.yumacountyaz.gov/recorder/eagleweb/docSearch.jsp'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            let dateRange = await this.getDateRange('Arizona', 'Yuma');
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                try {
                    ...
                    await page.goto('https://recorder.yumacountyaz.gov/recorder/eagleweb/docSearch.jsp');
            ...
            await AbstractProducer.sendMessage('Yuma', 'Arizona', countRecords, 'Civil & Lien');
            return false
        }

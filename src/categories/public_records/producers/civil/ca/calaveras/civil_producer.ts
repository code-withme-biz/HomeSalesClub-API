...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://recorderweb.calaverasgov.us/web/user/disclaimer'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        const civilUrl: string = 'https://recorderweb.calaverasgov.us/web/user/disclaimer';
        let countRecords = 0;
        try{
            let dateRange = await this.getDateRange('California', 'Calaveras');
            ...
            while (fromDate <= toDate) {
                ...
                let documentTypes = ['BANKRUPTY', 'EASEMENT', 'DEED', 'RENT', 'LIEN', 'MORTGAGE', 'MARRIAGE', 'PENDENS', 'JUDGMENT', 'JUDGEMENT', 'PROBATE'];
            ...
            await AbstractProducer.sendMessage('Calaveras', 'California', countRecords, 'Civil & Lien');
            return true;
        } catch(e){
            console.log(e);
            await AbstractProducer.sendMessage('Calaveras', 'California', countRecords, 'Civil & Lien');

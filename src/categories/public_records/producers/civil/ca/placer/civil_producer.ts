...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://countyfusion4.kofiletech.us/countyweb/login.do?countyname=Placer'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            let dateRange = await this.getDateRange('California', 'Placer');
            ...
            await AbstractProducer.sendMessage('Placer', 'California', countRecords, 'Civil & Lien');
            return false
        }
        await AbstractProducer.sendMessage('Placer', 'California', countRecords, 'Civil & Lien');
        return true;

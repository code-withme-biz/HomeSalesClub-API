...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://countyfusion2.kofiletech.us/countyweb/login.do?countyname=RouttCO'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            let dateRange = await this.getDateRange('Colorado', 'Routt');
            ...
            await AbstractProducer.sendMessage('Routt', 'Colorado', countRecords, 'Civil & Lien');
            return false
        }
        await AbstractProducer.sendMessage('Routt', 'Colorado', countRecords, 'Civil & Lien');
        return true;

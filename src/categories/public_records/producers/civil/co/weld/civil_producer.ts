...
const removeRowArray = [
    ...
    'MEDICAL', 'CONDOMINIUM ASSOCIATION', 'LOTS', 'Colorado STATE', 'VETERANS', 'SECRETARY', 'DEPARTMENT',
...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://weldrecorder.weldgov.com/web/search/DOCSEARCH528S1'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            let dateRange = await this.getDateRange('Colorado', 'Weld', 60);
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                ...
                try {
                    await page.goto('https://weldrecorder.weldgov.com/web/search/DOCSEARCH528S1', {waitUntil: 'load'});
                    await page.waitForXPath('//*[@id="field_RecordingDateID_DOT_StartDate"]', {timeout: 10000});
                    await page.evaluate(() => {
                        // @ts-ignore
                    ...
                    let jsonRes = await page.evaluate(() => {
                        return fetch('https://weldrecorder.weldgov.com/web/viewSearchResultsReport/DOCSEARCH528S1/CSV', {
                            method: 'GET',
                            credentials: 'include'
                        }).then(r => r.text());
                    });
            ...
            await AbstractProducer.sendMessage('Weld', 'Colorado', countRecords, 'Civil & Lien');
            return false;
        }
        await AbstractProducer.sendMessage('Weld', 'Colorado', countRecords, 'Civil & Lien');
        return true;

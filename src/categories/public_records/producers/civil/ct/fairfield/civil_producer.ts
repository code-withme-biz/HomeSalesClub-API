...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'https://www.searchiqs.com/CTFAI/Login.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try {
            const dateRange = await this.getDateRange('Connecticut', 'Fairfield', 60);
            ...
            try {
                ...
                console.log(error);
                await AbstractProducer.sendMessage('Fairfield', 'Connecticut', countRecords, 'Civil & Lien');
                return false;
            }
            ...
            await AbstractProducer.sendMessage('Fairfield', 'Connecticut', countRecords, 'Civil & Lien', errorImage);
        }

...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'https://www.searchiqs.com/CTHAR/Login.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try {
            const dateRange = await this.getDateRange('Connecticut', 'Hartford');
            ...
            try {
                ...
                console.log(error);
                await AbstractProducer.sendMessage('Hartford', 'Connecticut', countRecords, 'Civil & Lien');
                return false;
            }
            ...
            await AbstractProducer.sendMessage('Hartford', 'Connecticut', countRecords, 'Civil & Lien', errorImage);
        }

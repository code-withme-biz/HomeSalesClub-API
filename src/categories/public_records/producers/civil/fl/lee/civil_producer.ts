...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://or.leeclerk.org/LandMarkWeb/'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        const civilUrl: string = 'https://or.leeclerk.org/LandMarkWeb/';
        let countRecords = 0;
        try{
            ...
            while (fromDate <= toDate) {
                ...
                let documentTypes = ['DEED', 'MARRIAGE LICENSE', 'MORTGAGE', 'RELEASE/LIEN'];
            ...
            await AbstractProducer.sendMessage('Lee', 'Florida', countRecords, 'Civil & Lien');
            return true;
        } catch(e){
            console.log(e);
            await AbstractProducer.sendMessage('Lee', 'Florida', countRecords, 'Civil & Lien');

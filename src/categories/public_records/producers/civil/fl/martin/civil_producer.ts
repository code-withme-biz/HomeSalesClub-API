...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'http://or.martinclerk.com/LandmarkWeb/home/index'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            let docTypeSelects = [44, 71, 72, 1012, 1011, 1044, 1010, 1043, 77, 87]; 
            ...
            // setting date range
            const dateRange = await this.getDateRange('Florida', 'Martin');
            ...
            await AbstractProducer.sendMessage('Martin', 'Florida', countRecords, 'Civil & Lien');
            await page.close();

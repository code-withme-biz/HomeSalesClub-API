...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://apps.stjohnsclerk.com/Landmark/'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try{
            let dateRange = await this.getDateRange('Florida', 'St. Johns');
            ...
            while (fromDate <= toDate) {
                ...
                let documentTypes = ['Deed', 'Judgment', 'Lien', 'Lis Pendens', 'Mortgage', 'Notice of Contest of Lien', 'Probate Documents'];
            ...
            await AbstractProducer.sendMessage('St. Johns', 'Florida', countRecords, 'Civil & Lien');
            return true;
        } catch(e){
            console.log(e);
            const errorImage = await this.uploadImageOnS3(page);
            await AbstractProducer.sendMessage('St. Johns', 'Florida', countRecords, 'Civil & Lien', errorImage);
            return false;
        }
    }
}
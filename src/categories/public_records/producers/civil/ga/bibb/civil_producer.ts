...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://bibbclerkindexsearch.com/External/LandRecords/protected/SrchDateRange.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        const civilUrl: string = 'https://bibbclerkindexsearch.com/External/LandRecords/protected/SrchDateRange.aspx';
        let countRecords = 0;

        try {
            let dateRange = await this.getDateRange('Georgia', 'Bibb');
            ...
            await AbstractProducer.sendMessage('Bibb', 'Georgia', countRecords, 'Civil & Lien');
            return true;
        } catch (e) {
            console.log(e);
            await AbstractProducer.sendMessage('Bibb', 'Georgia', countRecords, 'Civil & Lien');

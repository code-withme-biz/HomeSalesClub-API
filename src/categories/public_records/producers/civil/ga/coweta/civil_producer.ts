...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://sccweb.coweta.ga.us/cmwebsearchppp/Custom_Search.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        // 2000
        try{
            let dateRange = await this.getDateRange('Georgia', 'Coweta', 60);
            ...
            if(resultRows.length < 2){
                ...
                await AbstractProducer.sendMessage('Coweta', 'Georgia', countRecords, 'Civil & Lien');
                return true;
            }
            resultRows.shift();
            let nextPage = true;
            ...
            while(nextPage){
                ...
                for(const resultRow of resultRows){
                    ...
                    url = 'https://sccweb.coweta.ga.us/cmwebsearchppp/' + url?.replace(/'|;/g, '');
                    console.log(url);

...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'http://fccottweb.fayettecountyga.gov/external/LandRecords/protected/SrchQuickName.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            let dateRange = await this.getDateRange('Georgia', 'Fayette');
            ...
            await AbstractProducer.sendMessage('Fayette', 'Georgia', countRecords, 'Civil & Lien');
            return true;
        } catch (e) {
            console.log(e);
            await AbstractProducer.sendMessage('Fayette', 'Georgia', countRecords, 'Civil & Lien');

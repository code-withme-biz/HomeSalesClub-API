...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://cotthosting.com/GAFloyd/User/Login.aspx?ReturnUrl=%2fGAFloyd%2fLandRecords%2fprotected%2fSrchDateRange.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            let dateRange = await this.getDateRange('Georgia', 'Floyd');
            ...
            try {
                ...
                await AbstractProducer.sendMessage('Floyd', 'Georgia', countRecords, 'Civil & Lien');
                return false;
            }

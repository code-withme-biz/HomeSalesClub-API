...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'http://cotthosting.com/GAHoustonExternal/LandRecords/protected/SrchQuickName.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        const civilUrl: string = 'http://cotthosting.com/GAHoustonExternal/LandRecords/protected/SrchQuickName.aspx';
        let countRecords = 0;

        try {
            let dateRange = await this.getDateRange('Georgia', 'Houston');
            ...
            try {
                ...
                await AbstractProducer.sendMessage('Houston', 'Georgia', countRecords, 'Civil & Lien');
                return false;
            }
            ...
            for (let i = 1; i <= numberOfPages; i++) {
                ...
                await page.waitForXPath('//table[@id="ctl00_cphMain_lrrgResults_cgvResults"]/tbody/tr[' + ((end - start) + 1) + ']', { visible: true, timeout: 500000 });

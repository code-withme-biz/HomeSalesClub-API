...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'http://www.cotthosting.com/IADallasExternal/LandRecords/protected/SrchQuickName.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        const civilUrl: string = 'http://www.cotthosting.com/IADallasExternal/LandRecords/protected/SrchQuickName.aspx';
        let countRecords = 0;

        try {
            let dateRange = await this.getDateRange('Iowa', 'Dallas');
            ...
            try {
                ...
                await AbstractProducer.sendMessage('Dallas', 'Iowa', countRecords, 'Civil & Lien');
                return false;
            }

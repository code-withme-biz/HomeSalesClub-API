...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://il4laredo.fidlar.com/ILChampaign/DirectSearch/#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        // 2000
        try{
            const civilUrl: string = 'https://il4laredo.fidlar.com/ILChampaign/DirectSearch/#!/search';
            let dateRange = await this.getDateRange('Illinois', 'Champaign');
            ...
            await AbstractProducer.sendMessage('Champaign', 'Illinois', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('Champaign', 'Illinois', countRecords, 'Civil & Lien');

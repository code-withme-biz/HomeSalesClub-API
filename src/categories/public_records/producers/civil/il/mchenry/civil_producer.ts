...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://il4laredo.fidlar.com/ILMcHenry/AvaWeb/#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        let countRecords = 0;
        try{
            const civilUrl: string = 'https://il4laredo.fidlar.com/ILMcHenry/AvaWeb/#!/search';
            let dateRange = await this.getDateRange('Illinois', 'Mchenry');
            ...
            await AbstractProducer.sendMessage('Mchenry', 'Illinois', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('Mchenry', 'Illinois', countRecords, 'Civil & Lien');

...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://ilsangamon.fidlar.com/ILSangamon/DirectSearch/#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        // 2000
        try{
            const civilUrl: string = 'https://ilsangamon.fidlar.com/ILSangamon/DirectSearch/#!/search';
            let dateRange = await this.getDateRange('Illinois', 'Sangamon');
            ...
            await AbstractProducer.sendMessage('Sangamon', 'Illinois', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('Sangamon', 'Illinois', countRecords, 'Civil & Lien');

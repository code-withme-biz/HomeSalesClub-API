...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://ilwill.fidlar.com/ILWill/AvaWeb/#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        // 2000
        try{
            const civilUrl: string = 'https://ilwill.fidlar.com/ILWill/AvaWeb/#!/search';
            let dateRange = await this.getDateRange('Illinois', 'Will');
            ...
            await AbstractProducer.sendMessage('Will', 'Illinois', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('Will', 'Illinois', countRecords, 'Civil & Lien');

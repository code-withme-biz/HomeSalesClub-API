...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://ilwinnebago.fidlar.com/ILWinnebago/DirectSearch/#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        // 2000
        try{
            const civilUrl: string = 'https://ilwinnebago.fidlar.com/ILWinnebago/DirectSearch/#!/search';
            let dateRange = await this.getDateRange('Illinois', 'Winnebago');
            ...
            await AbstractProducer.sendMessage('Winnebago', 'Illinois', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('Winnebago', 'Illinois', countRecords, 'Civil & Lien');

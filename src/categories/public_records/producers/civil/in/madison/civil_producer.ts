...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://in4laredo.fidlar.com/INMadison/DirectSearch/index.html#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        let countRecords = 0;
        try{
            const civilUrl: string = 'https://in4laredo.fidlar.com/INMadison/DirectSearch/index.html#!/search';
            let dateRange = await this.getDateRange('Indiana', 'Madison');
            ...
            await AbstractProducer.sendMessage('Madison', 'Indiana', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('Madison', 'Indiana', countRecords, 'Civil & Lien');

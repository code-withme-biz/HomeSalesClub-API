...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://instjoseph.fidlar.com/INStJoseph/DirectSearch/#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        // 2000
        try{
            const civilUrl: string = 'https://instjoseph.fidlar.com/INStJoseph/DirectSearch/#!/search';
            let dateRange = await this.getDateRange('Indiana', 'St. Joseph');
            ...
            await AbstractProducer.sendMessage('St. Joseph', 'Indiana', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('St. Joseph', 'Indiana', countRecords, 'Civil & Lien');

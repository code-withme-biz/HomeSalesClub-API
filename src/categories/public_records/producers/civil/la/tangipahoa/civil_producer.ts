...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://cotthosting.com/LATangipahoa/LandRecords/protected/SrchQuickName.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        const civilUrl: string = 'https://cotthosting.com/LATangipahoa/LandRecords/protected/SrchQuickName.aspx';
        let countRecords = 0;

        try {
            let dateRange = await this.getDateRange('Los Angeles', 'Tangipahoa');
            ...
            await AbstractProducer.sendMessage('Tangipahoa', 'Los Angeles', countRecords, 'Civil & Lien');
            return true;
        } catch (e) {
            console.log(e);
            await AbstractProducer.sendMessage('Tangipahoa', 'Los Angeles', countRecords, 'Civil & Lien');

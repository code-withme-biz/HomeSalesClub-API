...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://countyfusion7.kofiletech.us/countyweb/login.do?countyname=CalhounMI'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            let dateRange = await this.getDateRange('Michigan', 'Calhoun');
            ...
            await AbstractProducer.sendMessage('Calhoun', 'Michigan', countRecords, 'Civil & Lien');
            return false
        }
        await AbstractProducer.sendMessage('Calhoun', 'Michigan', countRecords, 'Civil & Lien');
        return true;

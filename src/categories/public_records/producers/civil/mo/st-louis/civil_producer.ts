...
export default class CivilProducer extends AbstractProducer {
            ...
            while (hasNext) {
                ...
                for (let i = 0 ; i < paginations.length ; i++) {
                    ...
                    for (const row of rows) {
                        ...
                        const parseName:any = this.newParseNameFML(name);
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try {
            let dateRange = await this.getDateRange('Missouri', 'St. Louis');
            ...
            await AbstractProducer.sendMessage('St. Louis', 'Missouri', countRecords, 'Civil & Lien');
            return false;
        }
        await AbstractProducer.sendMessage('St. Louis', 'Missouri', countRecords, 'Civil & Lien');
        return true;

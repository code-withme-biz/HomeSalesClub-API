...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'http://www.catawbarod.org/'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {            
            ...
            const dateRange = await this.getDateRange('North Carolina', 'Catawba');
            ...
            await AbstractProducer.sendMessage('Catawba', 'North Carolina', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Catawba', 'North Carolina', countRecords, 'Civil & Lien', errorImage);
        }

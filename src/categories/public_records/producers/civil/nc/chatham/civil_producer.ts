...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'http://www.chathamncrod.org/'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {            
            ...
            const dateRange = await this.getDateRange('North Carolina', 'Chatham');
            ...
            while (true) {
                ...
                await page.waitForXPath('//div[contains(@id, "VWGROW2_140_R")]', {timeout: 3000});
            ...
            await AbstractProducer.sendMessage('Chatham', 'North Carolina', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Chatham', 'North Carolina', countRecords, 'Civil & Lien', errorImage);
        }
        return false;
    }

...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'http://cotthosting.com/ncedgecombeexternal/User/Login.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            // guest login
            await Promise.all([
                page.click('#ctl00_cphMain_blkLogin_btnGuestLogin'),
            ...
            const dateRange = await this.getDateRange('North Carolina', 'Edgecombe');
            ...
            await AbstractProducer.sendMessage('Edgecombe', 'North Carolina', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Edgecombe', 'North Carolina', countRecords, 'Civil & Lien', errorImage);
            return false;
        }
    }

...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'https://deeds.co.gaston.nc.us/external/LandRecords/protected/v4/SrchName.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        const dateRange = await this.getDateRange('North Carolina', 'Gaston');
        ...
        try {
            ...
            await AbstractProducer.sendMessage('Gaston', 'North Carolina', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Gaston', 'North Carolina', countRecords, 'Civil & Lien', errorImage);
        }

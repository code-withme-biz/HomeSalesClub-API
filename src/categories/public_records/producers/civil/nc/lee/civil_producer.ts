...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'http://www.leencrod.org/Opening.asp'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {            
            ...
            const dateRange = await this.getDateRange('North Carolina', 'Lee');
            ...
            await AbstractProducer.sendMessage('Lee', 'North Carolina', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Lee', 'North Carolina', countRecords, 'Civil & Lien', errorImage);
        }

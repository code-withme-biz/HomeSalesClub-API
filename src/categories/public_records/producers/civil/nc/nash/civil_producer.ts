...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'https://cotthosting.com/NCNashExternal/LandRecords/protected/v4/SrchName.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            const dateRange = await this.getDateRange('North Carolina', 'Nash');
            ...
            await AbstractProducer.sendMessage('Nash', 'North Carolina', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Nash', 'North Carolina', countRecords, 'Civil & Lien', errorImage);
            return false;
        }
    }

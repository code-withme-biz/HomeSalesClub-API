...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'http://www.unionconcrod.org/'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {            
            ...
            const dateRange = await this.getDateRange('North Carolina', 'Union');
            ...
            await AbstractProducer.sendMessage('Union', 'North Carolina', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Union', 'North Carolina', countRecords, 'Civil & Lien', errorImage);
        }

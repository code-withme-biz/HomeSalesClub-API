...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://ava.fidlar.com/NHGrafton/AvaWeb/#!/search'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        // 2000
        try{
            const civilUrl: string = 'https://ava.fidlar.com/NHGrafton/AvaWeb/#!/search';
            let dateRange = await this.getDateRange('New Hampshire', 'Grafton');
            ...
            await AbstractProducer.sendMessage('Grafton', 'New Hampshire', countRecords, 'Civil & Lien');
            return true;
        } catch (error){
            console.log(error);
            await AbstractProducer.sendMessage('Grafton', 'New Hampshire', countRecords, 'Civil & Lien');

...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'https://www.searchiqs.com/NJWAR/LogIn.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try {
            const dateRange = await this.getDateRange('New Jersey', 'Warren');
            ...
            try {
                ...
                console.log(error);
                await AbstractProducer.sendMessage('Warren', 'New Jersey', countRecords, 'Civil & Lien');
                return false;
            }

            let docTypeSelects = [
                'D', 'L', 'LP', 'MAP', 'M', 'MU', 'RAD', 'TN'
            ];
            ...
            await AbstractProducer.sendMessage('Warren', 'New Jersey', countRecords, 'Civil & Lien', errorImage);
        }

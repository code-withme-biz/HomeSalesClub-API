...
const removeRowArray = [
    ...
    'MEDICAL', 'CONDOMINIUM ASSOCIATION', 'LOTS', 'TEXAS STATE', 'VETERANS', 'SECRETARY', 'DEPARTMENT', 'CITIBANK'
]
...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://eagleweb.bernco.gov/recorder/eagleweb/docSearch.jsp'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            let dateRange = await this.getDateRange('New Mexico', 'Bernalillo');
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                try {
                    ...
                    await page.goto('https://eagleweb.bernco.gov/recorder/eagleweb/docSearch.jsp');
                    ...
                    await page.type('#RecDateIDStart', dateSearch.toLocaleDateString('en-US', {
                        year: "numeric",
                        month: "2-digit",
                        day: "2-digit"
                    }), {delay: 100});
                    await page.type('#RecDateIDEnd', dateSearch.toLocaleDateString('en-US', {
                        year: "numeric",
                        month: "2-digit",
                        day: "2-digit"
                    }), {delay: 100});
            ...
            await AbstractProducer.sendMessage('Bernalillo', 'New Mexico', countRecords, 'Civil & Lien', errorImage);
            return false
        }

        await AbstractProducer.sendMessage('Bernalillo', 'New Mexico', countRecords, 'Civil & Lien');

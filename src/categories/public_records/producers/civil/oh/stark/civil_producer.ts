...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://countyfusion12.kofiletech.us/countyweb/loginDisplay.action?countyname=StarkOH'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            await page.waitForXPath('//*[@id="menudiv"]//*[contains(text(), "Search Public Records")]', {visible: true});
            ...
            let dateRange = await this.getDateRange('Ohio', 'Stark');
            ...
            await AbstractProducer.sendMessage('Stark', 'Ohio', countRecords, 'Civil & Lien');
            return false
        }
        await AbstractProducer.sendMessage('Stark', 'Ohio', countRecords, 'Civil & Lien');
        return true;

...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'https://www.searchiqs.com/pabea/LogIn.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            try {
                ...
                console.log(error);
                await AbstractProducer.sendMessage('Beaver', 'Pennsylvania', countRecords, 'Civil & Lien');
                return false;
            }

            // setting doc type
            await page.select('select[id="ContentPlaceHolder1_cboDocGroup"]', 'RP');
            await page.waitForNavigation();
            ...
            await AbstractProducer.sendMessage('Beaver', 'Pennsylvania', countRecords, 'Civil & Lien', errorImage);
        }

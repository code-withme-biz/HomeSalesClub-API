...
export default class CivilProducer extends AbstractProducer {
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try {
            const dateRange = await this.getDateRange('Pennsylvania', 'Blair');
            ...
            await AbstractProducer.sendMessage('Blair', 'Pennsylvania', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Blair', 'Pennsylvania', countRecords, 'Civil & Lien', errorImage);
        }

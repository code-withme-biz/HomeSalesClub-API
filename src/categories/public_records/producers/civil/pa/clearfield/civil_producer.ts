...
export default class CivilProducer extends AbstractProducer {
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            if (!result) {
                await AbstractProducer.sendMessage('Clearfield', 'Pennsylvania', countRecords, 'Civil & Lien');
                return false;
            }
            ...
            await AbstractProducer.sendMessage('Clearfield', 'Pennsylvania', countRecords, 'Civil & Lien', errorImage);
        }

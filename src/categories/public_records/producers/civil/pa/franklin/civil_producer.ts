...
export default class CivilProducer extends AbstractProducer {
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            await AbstractProducer.sendMessage('Franklin', 'Pennsylvania', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Franklin', 'Pennsylvania', countRecords, 'Civil & Lien', errorImage);
        }

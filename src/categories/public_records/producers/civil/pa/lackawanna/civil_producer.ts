...
export default class CivilProducer extends AbstractProducer {
    urls = {
        generalInfoPage: 'https://www.searchiqs.com/PALAC/Login.aspx'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try {
            const dateRange = await this.getDateRange('Pennsylvania', 'Lackawanna');
            ...
            let docTypeSelects = ['D', 'M', 'U'];
            for (const docTypeSelect of docTypeSelects) {
                // setting doc group type
            ...
            await AbstractProducer.sendMessage('Lackawanna', 'Pennsylvania', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Lackawanna', 'Pennsylvania', countRecords, 'Civil & Lien', errorImage);
        }

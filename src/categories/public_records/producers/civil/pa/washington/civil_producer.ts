...
export default class CivilProducer extends AbstractProducer {
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        let countRecords = 0;
        try {
            const dateRange = await this.getDateRange('Pennsylvania', 'Washington');
            ...
            await AbstractProducer.sendMessage('Washington', 'Pennsylvania', countRecords, 'Civil & Lien');
            await page.close();
            ...
            await AbstractProducer.sendMessage('Washington', 'Pennsylvania', countRecords, 'Civil & Lien', errorImage);
        }

...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://countyfusion10.kofiletech.us/countyweb/loginDisplay.action?town=ProvidenceRI&countyname=TownFusion'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            let dateRange = await this.getDateRange('Rhode Island', 'Providence', 60);
            ...
            await AbstractProducer.sendMessage('Providence', 'Rhode Island', countRecords, 'Civil & Lien');
            return false
        }
        await AbstractProducer.sendMessage('Providence', 'Rhode Island', countRecords, 'Civil & Lien');
        return true;

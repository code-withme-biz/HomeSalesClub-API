...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://search.berkeleydeeds.com/NameSearch.php?Accept=Accept'
    }
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try{
            ...
            let dateRange = await this.getDateRange('South Carolina', 'Berkeley');
            ...
            await AbstractProducer.sendMessage('South Carolina', 'Berkeley', countRecords, 'Civil');
            return true;
        } catch (error){
            console.log(error);
            const errorImage = await this.uploadImageOnS3(page);
            await AbstractProducer.sendMessage('South Carolina', 'Berkeley', countRecords, 'Civil', errorImage);
            return false;
        }
    }
}
...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://libertycountytx-web.tylerhost.net/web/search/DOCSEARCH144S1'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                ...
                try {
                    await page.goto('https://libertycountytx-web.tylerhost.net/web/search/DOCSEARCH144S1', {waitUntil: 'load'});
                    ...
                    let jsonRes = await page.evaluate(() => {
                        return fetch('https://libertycountytx-web.tylerhost.net/web/viewSearchResultsReport/DOCSEARCH144S1/CSV', {
                            method: 'GET',
                            credentials: 'include'
                        }).then(r => r.text());
                    });
            ...
            await AbstractProducer.sendMessage('Liberty', 'Texas', countRecords, 'Civil & Lien');
            return false;
        }
        await AbstractProducer.sendMessage('Liberty', 'Texas', countRecords, 'Civil & Lien');
        return true;

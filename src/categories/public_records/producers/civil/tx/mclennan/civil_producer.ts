...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://mclennantx.countygovernmentrecords.com/MclennanClerk/eagleweb/docSearch.jsp'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            let dateRange = await this.getDateRange('Texas', 'Mclennan');
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                try {
                    ...
                    await page.goto('https://mclennantx.countygovernmentrecords.com/MclennanClerk/eagleweb/docSearch.jsp');
            ...
            await AbstractProducer.sendMessage('McLennan', 'Texas', countRecords, 'Civil & Lien');
            return false
        }

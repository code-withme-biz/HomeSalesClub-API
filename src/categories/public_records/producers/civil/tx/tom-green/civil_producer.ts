...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://tomgreentx.countygovernmentrecords.com/TomGreenTXRecorder/eagleweb/docSearch.jsp'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            let dateRange = await this.getDateRange('Texas', 'Tom Green');
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                try {
                    ...
                    await page.goto('https://tomgreentx.countygovernmentrecords.com/TomGreenTXRecorder/eagleweb/docSearch.jsp');
            ...
            await AbstractProducer.sendMessage('Tom Green', 'Texas', countRecords, 'Civil & Lien');
            return false
        }

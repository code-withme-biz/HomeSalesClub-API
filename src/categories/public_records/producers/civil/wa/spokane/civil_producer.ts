...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://recording.spokanecounty.org/recorder/eagleweb/docSearch.jsp'
    };
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            let dateRange = await this.getDateRange('Washington', 'Spokane');
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                try {
                    ...
                    await page.goto('https://recording.spokanecounty.org/recorder/eagleweb/docSearch.jsp');
            ...
            await AbstractProducer.sendMessage('Spokane', 'Washington', countRecords, 'Civil & Lien');
            return false
        }

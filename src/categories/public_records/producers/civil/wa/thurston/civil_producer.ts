...
export default class CivilProducer extends AbstractProducer {
    ...
    urls = {
        generalInfoPage: 'https://eagleweb.co.thurston.wa.us/thurstonrecorder/eagleweb/docSearch.jsp'
    };
            ...
            do {
                ...
                for (let i = 1; i < rows.length; i++) {
                    ...
                    if (nameHandle.length > 0) {
                        ...
                        let recordDate = await recordDateArray.split(' ');
    ...
    async parseAndSave(): Promise<boolean> {
        ...
        try {
            do {
                ...
                await page.click('input[type="submit"][value="Public Log In"][name="submit"]');
        ...
        try {
            let dateRange = await this.getDateRange('Washington', 'Thurston');
            ...
            for (let i = days < 0 ? 1 : days; i >= 0; i--) {
                try {
                    ...
                    await page.goto('https://eagleweb.co.thurston.wa.us/thurstonrecorder/eagleweb/docSearch.jsp');
            ...
            await AbstractProducer.sendMessage('Thurston', 'Washington', countRecords, 'Civil & Lien');
            return false
        }

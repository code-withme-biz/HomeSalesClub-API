...
export default class CivilProducer extends AbstractProducer {
    sources =
        [
            { url: 'http://trakitweb.bentonvillear.com/etrakit/login.aspx?lt=either&rd=~/Search/case.aspx', handler: this.handleSource1 },
        ];
    username = 'webdev1234';
    ...
    async setSearchCriteria1(page: puppeteer.Page, prefix: number) {
        ...
        let searchKey = `CE${year}-${prefix.toString().padStart(3, '0')}`;

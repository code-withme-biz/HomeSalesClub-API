...
export default class CivilProducer extends AbstractProducer {
    sources =
        [
            { url: 'https://etrakit3.novato.org/eTRAKiT3/Search/case.aspx', handler: this.handleSource1 },
        ];
    username = 'webdev1234';
    ...
    async handleSource1(page: puppeteer.Page, link: string, sourceId: number) {
        ...
        const isPageLoaded = await this.openPage(page, link, '//*[@id="cplMain_btnSearch"]');
        if (!isPageLoaded) {

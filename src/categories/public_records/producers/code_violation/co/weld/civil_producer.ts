...
export default class CivilProducer extends AbstractProducer {
    ...
    sources =
      [
        { url: 'https://accela-aca.co.weld.co.us/CitizenAccess/Cap/CapHome.aspx?module=Enforcement', handler: this.handleSource1 }
      ];
    ...
    async getData1(page: puppeteer.Page, sourceId: number) {
        let counts = 0, pageNum = 1, url = 'https://accela-aca.co.weld.co.us';

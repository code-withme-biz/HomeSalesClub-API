...
export default class CivilProducer extends AbstractProducer {
    ...
    sources = [
        { url: 'https://acaweb.brevardcounty.us/CitizenAccess/Cap/CapHome.aspx?module=Enforce&TabName=HOME', handler: this.handleSource },
        { url: 'https://energovweb.mlbfl.org/EnerGovProd/SelfService#/search', handler: this.handleSource2 }
    ];
    ...
    async getData(page: puppeteer.Page, sourceId: number) {
        let counts = 0, pageNum = 1, url = 'https://acaweb.brevardcounty.us';

...
export default class CivilProducer extends AbstractProducer {
    ...
    sources = [
        {
            url: 'https://energovweb.jacksoncoga.gov/EnerGovProd/SelfService/api/energov/search/search',
    ...
    async handleSource1(page: puppeteer.Page, url: string, sourceId: number) {
        ...
        const response = await axios.post('https://energovweb.jacksoncoga.gov/EnerGovProd/SelfService/api/energov/search/search', axiosData, axiosConfig)

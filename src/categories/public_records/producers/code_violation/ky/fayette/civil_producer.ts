...
export default class CivilProducer extends AbstractProducer {
    ...
    sources =
      [
        { url: 'https://aca-prod.accela.com/LEXKY/Cap/CapHome.aspx?module=Building&TabName=Home', handler: this.handleSource1 }
      ];
    ...
    async getData1(page: puppeteer.Page, sourceId: number) {
        ...
        while (true) {            
            ...
            for (const row of rows) {
                ...
                const addressHandle = await detailPage.$x('//table[@id="ctl00_PlaceHolderMain_PermitDetailList1_TBPermitDetailTest"]/tbody/tr[2]/td/div/span/table/tbody//table//tr[2]/td');

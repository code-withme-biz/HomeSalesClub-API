...
export default class CivilProducer extends AbstractProducer {
    ...
    sources =
      [
        { url: 'https://permits.springfieldcityhall.com/CitizenAccess/Cap/CapHome.aspx?module=Enforcement&TabName=Enforcement', handler: this.handleSource1 }
      ];
    ...
    async getData1(page: puppeteer.Page, sourceId: number) {
        let counts = 0, pageNum = 1, url = 'https://permits.springfieldcityhall.com/';

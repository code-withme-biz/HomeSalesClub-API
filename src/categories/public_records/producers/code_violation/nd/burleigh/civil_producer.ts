...
export default class CivilProducer extends AbstractProducer {
    sources =
        [
            { url: 'https://trakitapi.bismarcknd.gov/etrakit/login.aspx?lt=either&rd=~/Search/case.aspx', handler: this.handleSource1 },
        ];
    username = 'webdev1234';
    password = 'eQJAHy!8Px7bBM3';
    ...
    async setSearchCriteria1(page: puppeteer.Page, prefix: number) {
        ...
        let searchKey = `${year}-${prefix.toString().padStart(4, '0')}`;

...
export default class CivilProducer extends AbstractProducer {
    ...
    sources =
        [
            { url: 'https://www.omahapermits.com/PermitInfo/Cap/CapHome.aspx?module=Enforcement&TabName=Enforcement', handler: this.handleSource1 },
            { url: 'https://omaharr.cityofomaha.org/CitizenAccessRental/Cap/CapHome.aspx?module=Service_Request', handler: this.handleSource2 }
        ];
    ...
    async getData1(page: puppeteer.Page, sourceId: number) {
        ...
        try {
            await page.goto('https://www.omahapermits.com/PermitInfo/Cap/CapHome.aspx?module=Enforcement&TabName=Enforcement');
    ...
    async getData2(page: puppeteer.Page, sourceId: number) {
        let counts = 0, pageNum = 1, url = 'https://omaharr.cityofomaha.org/';

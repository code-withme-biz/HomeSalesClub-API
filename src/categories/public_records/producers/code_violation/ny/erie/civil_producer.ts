...
export default class CivilProducer extends AbstractProducer {
    ...
    sources = [
        { url: 'https://data.buffalony.gov/resource/ivrf-k9vm.json?status=ACTIVE', handler: this.handleSource, casetype: 'Code Violations' },
        { url: 'https://data.buffalony.gov/resource/abwd-pczc.json?status=ACTIVE', handler: this.handleSource, casetype: 'Active Code Violations' },
    ];

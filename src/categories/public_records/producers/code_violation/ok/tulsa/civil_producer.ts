...
export default class CivilProducer extends AbstractProducer {
    ...
    sources = [
        { url: 'https://tulsaok.tylertech.com/EnerGov4934/SelfService#/search', handler: this.handleSource }
    ];
    ...
    async saveRecord(record: any) {
        ...
        let propertyCity = parsed.city ? parsed.city : '';
        if (propertyCity == 'Tulsa Tulsa') {
            propertyCity = 'Tulsa';
        }
        const data = {

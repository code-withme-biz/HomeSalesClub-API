...
export default class CivilProducer extends AbstractProducer {
    ...
    sources =
      [
        { url: 'https://aca-prod.accela.com/TIGARD/Cap/CapHome.aspx?module=Enforce', handler: this.handleSource1 }
      ];
    ...
    async getData1(page: puppeteer.Page, sourceId: number) {
        ...
        while (true) {            
            ...
            for (const row of rows) {
                ...
                const typeHandle = await detailPage.$x('//span[contains(@id, "PermitType")]');

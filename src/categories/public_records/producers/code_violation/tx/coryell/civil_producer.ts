...
export default class CivilProducer extends AbstractProducer {
    sources =
        [
            { url: 'https://www.municipalonlinepayments.com/copperascovetx/callcenter/search/incidenttype', handler: this.handleSource1 },
        ];
    ...
    async handleSource1(page: puppeteer.Page, link: string, sourceId: number) {
        ...
        let fromDate = await this.getPrevCodeViolationId(sourceId, false, 1);
    ...
    async getData1(page: puppeteer.Page, sourceId: number, fromDate: any) {
        ...
        while (true) {
            const rowXpath = '//*[@id="search_results"]//tbody/tr';

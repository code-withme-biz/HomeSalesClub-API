...
export default class CivilProducer extends AbstractProducer {
    ...
    sources =
      [
        { url: 'https://epermits.elpasotexas.gov/CitizenAccess/Cap/CapHome.aspx?module=Enforcement&TabName=HOME', handler: this.handleSource1 }
      ];
    ...
    async getData1(page: puppeteer.Page, sourceId: number) {
        let counts = 0, pageNum = 1, url = 'https://epermits.elpasotexas.gov';
